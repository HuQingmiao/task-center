...
import com.github.walker.taskcenter.vo.SysCodes;
...
public class XmlUtil {
    ...
    public static void main(String[] args) {
        ...
        Map<String,AppReg> map = new HashMap<String,AppReg>();
        AppReg a1 = new AppReg();
        a1.setId(new Long(5));
        map.put("a1",a1);

        AppReg a2 = new AppReg();
        a2.setId(new Long(6));

        SysCodes b = new SysCodes();

        System.out.println(a1.toString() + "  " + a1.hashCode());

        System.out.println(a2.toString() + "  " + a2.hashCode());


        System.out.println(map.get("a1").getId());

        AppReg r= map.get("a1"); r=a2;
