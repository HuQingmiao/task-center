        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <sf:form id="appRegForm" class="form-horizontal" action="${base}/appmgr/updateApp" method="post"
                                 modelAttribute="form">
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    <button id="updateApp" class="btn btn-info" type="button">
...
<script type="text/javascript">
    $("#updateApp").click(function () {
        ...
        $('#appRegForm').attr("action","${base}/appmgr/updateApp");
        $('#appRegForm').submit();
    });
    $("#back").click(function () {
