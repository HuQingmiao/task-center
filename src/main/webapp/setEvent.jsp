        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <sf:form id="appRegForm" class="form-horizontal" action="${base}/appmgr/setEvent" method="post"
                                 modelAttribute="form">
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label no-padding-right" >是否启用事件调度</label>

                                <div class="col-sm-8">
                                    &nbsp;&nbsp;
                                    开启 <sf:radiobutton onclick="showSetting(this)" path="eventEnable" value="1"/>
                                    &nbsp;&nbsp;&nbsp;
                                    关闭 <sf:radiobutton onclick="showSetting(this)" path="eventEnable" value="0"/>
                                </div>
                            </div>


                            <div id="settingPanel" class="form-group" style="visibility: hidden">
                                <label class="col-sm-4 control-label no-padding-right">MQ消息文本</label>

                                <div class="col-sm-8">
                                    <sf:input class="col-xs-5 col-sm-2" path="mqEventCode" maxlength="20" readonly="true"/>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        var enable = $("input[name='eventEnable']:checked").val();
