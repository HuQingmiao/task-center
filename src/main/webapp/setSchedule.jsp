...
<!--body class="no-skin" onload="resizeTo(600,500)"-->
<body class="no-skin" >
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <c:if test='${error != null}'>
                    <div style="color:#ff5a29; font-size: 18px; font-weight: bolder; height: 20px; text-align: center; position:relative; left:-16%;">
                            ${error}
                    </div>
                </c:if>
                <c:if test='${success != null}'>
                    <div style="color:#0eb839;font-size: 18px;  font-weight: bolder; height: 20px; text-align: center; position:relative; left:-16%;">
                            ${success}
                    </div>
                </c:if>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <sf:form id="appRegForm" class="form-horizontal" action="${base}/appmgr/setSchedule"
                            ...
                            <div class="form-group">
                                <label class="col-sm-4 control-label no-padding-right">是否启用时间片调度</label>

                                <div class="col-sm-8">
                                    &nbsp;&nbsp;&nbsp;
                                    开启&nbsp;&nbsp;<sf:radiobutton onclick="showSetting(this)"
                                                                  path="scheduleEnable" value="1"/>
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    关闭&nbsp;&nbsp;<sf:radiobutton onclick="showSetting(this)"
                                                                  path="scheduleEnable" value="0"/>
                                </div>
                            </div>

                            <div id="settingPanel" class="form-group">
                                <label class="col-sm-4 control-label no-padding-right">调度间隔时间</label>

                                <div class="col-sm-8">
                                    &nbsp;&nbsp;
                                    <sf:input path="cronExpression" maxlength="5" size="6"
                                              onkeyup="this.value=this.value.replace(/\D/g,'')"
                                              onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
                                    &nbsp;
                                    <sf:select path="timeUnit" class="chosen-select" cssStyle="width: 60px"
                                               data-placeholder="Choose a timer unit...">
                                        <sf:option value="d">天</sf:option>
                                        <sf:option value="h">小时</sf:option>
                                        <sf:option value="m">分钟</sf:option>
                                        <sf:option value="s">秒</sf:option>
                                    </sf:select><br/><br/>
                                </div>
                            </div>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    <button id="submitBut" class="btn btn-info" type="button">
...
<script type="text/javascript">
    $(document).ready(function () {
        var enable = $("input[name='scheduleEnable']:checked").val();

        if (enable == '1') {
            $('#settingPanel').attr("style", "visibility: visible");
        }
        else if (enable == '0') {
            $('#settingPanel').attr("style", "visibility: hidden");
        }
    });
